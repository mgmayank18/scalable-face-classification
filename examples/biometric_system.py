...
dataset = datasets.ImageFolder('../data/VGGFace2/train_cropped')#_split')
...
#weights=torch.load('./saved_models_first_pretrain/epoch_29.pt')
#resnet.load_state_dict(weights)

resnet = load_orig_task_weights(resnet,'./saved_models_first_pretrain/epoch_29.pt')
