...
class InceptionResnetV1_LWF(nn.Module):
    ...
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None):
        ...
        self.last_linear_new_task = nn.Linear(1792, 512, bias=False)
        self.last_bn_new_task = nn.BatchNorm1d(512, eps=0.001, momentum=0.1, affine=True)
